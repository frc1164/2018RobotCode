...
public class AutoTurn extends Command {
    ...
    protected void execute() {
    	...
    	if (TurnAngle > 0) {
    		...
    		Robot.kChassis.setRightSpeed(this.Speed);
    		Robot.kChassis.setLeftSpeed(-1*this.Speed);
    		
    	}
    	else if (TurnAngle < 0) {
    		
    		Robot.kChassis.setRightSpeed(-1*this.Speed);
    		Robot.kChassis.setLeftSpeed(this.Speed);
